...
@section('contenu')
    <div class="col-sm-offset-4 col-sm-4">
		...
		<div class="panel panel-primary">	
			<div class="panel-heading">Modification d'un compositeur</div>
			<div class="panel-body"> 
				<div class="col-sm-12">
					{!! Form::model($compositeur, ['route' => ['compositeur.update', $compositeur->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
